...
/// @tparam p 
template <int p>
class ABMs : public LinearMultistep {
private:
...
/// @tparam p 
template <int p>
class AMMs : public LinearMultistep {
private:
    vector<Array> Initialize(const IVPInfo& IVPInfo);
public:
    AMMs() = default;
...
/// @tparam p
template <int p>
class BDFs : public LinearMultistep {
private:
    vector<Array> Initialize(const IVPInfo& IVPInfo);
public:
    BDFs() = default;
